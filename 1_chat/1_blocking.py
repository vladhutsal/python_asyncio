# TODO:
# Now chat exits after the server receives the client message
# We need to echo all clients messages until client disconnects
...
def echo_message():
    ...
    print(f'message from {client_socket.getpeername()}: {str_data}')
    str_data = recieved_data.decode('UTF-8')
